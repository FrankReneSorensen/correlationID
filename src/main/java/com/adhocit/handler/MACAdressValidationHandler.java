...
public class MACAdressValidationHandler implements SOAPHandler<SOAPMessageContext> {

	String arr[] = { "E0-DB-55-A4-10-Z4", "E0-DB-55-A4-10-Z5", "E0-DB-55-A4-10-Z6", "E0-DB-55-A4-10-Z7" };
	...
	public boolean handleMessage(SOAPMessageContext context) {
		...
		// If its an incoming message from client, then outBoundProperty will be
		// false
		if (!outBoundProperty) {
			try {
				...
				// if no header block for next actor found,then throw
				// SOAPFaultException
